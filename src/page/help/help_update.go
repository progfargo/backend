...
func Update(rw http.ResponseWriter, req *http.Request) {
	...
	res, err := tx.Exec(sqlStr, title, summary, body, helpId)
	if err != nil {
		tx.Rollback()
...
func updateForm(ctx *context.Ctx, rec *help_lib.HelpRec) {
	content.Include(ctx)

	ctx.Js.Add("/asset/tinymce/tinymce.min.js")
	ctx.Js.Add("/asset/tinymce/tinymce_func.js")

	ctx.Js.Add("/asset/js/page/help/help_update.js")
	...
	buf.Add(content.PageTitle(ctx.T("Help"), ctx.T("Update Record")))
	buf.Add("</div>")
